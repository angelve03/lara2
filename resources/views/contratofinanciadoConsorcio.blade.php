...
<body>
    ...
    <h1>CONTRATO DE COMPROMISO DE COMPRA VENTA FINANCIADO</h1>

    <p>Conste el presente documento un CONTRATO PRIVADO DE COMPROMISO DE COMPRA VENTA FINANCIADO, que celebra de una parte:</p>

    <div class="clause">
        <p>
        a)	De una parte, declara el <b>CONSORCIO CUMBRES,</b> con R.U.C. N° 20612931161, con domicilio en calle Torres Paz 708, distrito de Chiclayo, provincia de     Chiclayo y departamento de Lambayeque, debidamente representada por su Gerente JORGE LUIS YACILA SIANCAS, identificado con DNI N°16414190, según facultades otorgadas mediante el Contrato de Consorcio, suscrito ante el notario público a quien en lo sucesivo se denominará <b>EL CONSORCIO</b>, y;</p>
        <p>
        b)	De otra JILMER WESLEY BECERRA VASQUEZ, identificado con DNI N°80244434, de estado civil SOLTERO, con domicilio en AV PRINCIPAL S/N CP EL PARCO BAGUA Distrito EL PARCO, Provincia BAGUA y Departamento de AMAZONAS, con número de celular 942754568/004917663106632, con correo electrónico,Christiangonzales9340@gmail.com a quien en adelante se le denominará EL COMPRADOR; </p>
    </div>
  ...
  <div class="clause">
    ...
    <p>CPRECISAR PERÍMETRO Y DIMENSIONES DE LOTES</p>
            ...
            <li>POR LA DERECHA: CON MZ I LT 9</li>
            <li>POR EL FONDO: CON MZ I LT 5</b></li>
            <li>POR LA IZQUIERDA: CON MZ I LT 7</li>
            </ul>
    ...
    <p><b><u>QUINTO: PRECIO Y FORMA DE PAGO:</u></b></p>
        ...
        <p>El precio del bien objeto de la prestación a cargo de EL VENDEDOR asciende a la suma de S/ 60,193.00 (Sesenta Mil Ciento Noventa y Tres Soles), dicho precio se encuentra ya con el descuento del BFH que será cancelado por EL COMPRADOR mediante depósito en la cuenta del CONSORCIO en la forma establecida conforme al Cronograma de Pago descrito en el ANEXO 1.</p>
        <p>Su inicial abonada es de s/.  6,000.00 (Seis Mil Soles) y el saldo de S/ 54,193.00 (Cincuenta y Cuatro Mil Ciento Noventa y Tres Soles) será financiado según cronograma de pagos ANEXO 1.</p>
    ...
    <p><b><u>DECIMO CUARTO: DE LA RESOLUCIÓN DEL CONTRATO:</u></b></p>
        ...
        <p>d)	Si EL COMPRADOR no cumple con su obligación de cancelar el precio pactado sobre el inmueble descrito en la Cláusula Quinta, en la forma y fecha convenidas, el contrato quedará resuelto y el VENDEDOR, conservará de modo definitivo la suma de dinero entregado por parte del COMPRADOR con anterioridad a la fecha de resolución de contrato.</p>
