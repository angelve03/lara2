...
<body>
    ...
    <div class="clause">
        ...
        <p>
        <b>EL CONSORCIO está compuesto por tres personas jurídicas que persiguen similares objetivos, INMOBILIARIA &CONSTRUTORA ALI TORRES E.I.R.L., identificada con RUC N°20605585907, inscrita en la Partida Electrónica N°11328386 del Registro de Personas Jurídicas de la Oficina Registral de Chiclayo, representada por su Gerente General ELVIS HENRY TORRES SALDAÑA, identificado con DNI N° 42225869, con poderes inscritos en el asiento N° C00001, de la referida partida electrónica y QUBO GRUPO DESARROLLADOR S.A.C., con RUC N° 20609441136, inscrita en la Partida Electrónica N°11395373 del Registro de Personas Jurídicas de la Oficina Registral de Chiclayo, representada por su Gerente General JORGE LUIS YACILA SIANCAS, identificado con DNI N° 16414190, con poderes inscritos en el asiento A00001 de la referida partida electrónica, SERVICIO A LA CONSTRUCCION MINERIA Y PETROLEO SRL., identificada con RUC N° 20606684348, inscrita en la partida Electrónica N° 11343668 del registro de personas jurídicas de la oficina Registral de Chiclayo representada por su gerente general CARRASCO OSORIO ROBERTO CARLOS , identificado con DNI N° 71099586 , con poderes inscritos en el asiento B00001 de la referida partida electrónica quienes unidas mediante el contrato suscrito ante el notario público, respectivamente, constituyen el “CONSORCIO CUMBRES”; siendo la última de estas, el encargado de asumir la gerencia comercial del consorcio.       
        </p>
    ...
    <p>
    <b>EL CONSORCIO, ha elaborado un proyecto de habilitación urbana con construcción simultanea de viviendas en adquisición de vivienda nueva del programa Techo Propio del fondo mi vivienda denominada “CONDOMINIO LA RIBERA”, que en adelante se denominará EL PROYECTO.
        </p>
        <b>Asimismo, la empresa INMOBILIARIA &CONSTRUTORA ALI TORRES E.I.RL., identificada con RUC N°20605585907, inscrita en la Partida Electrónica N°11328386 del Registro de Personas Jurídicas de la Oficina Registral de Chiclayo, representada por su Gerente General ELVIS HENRY TORRES SALDAÑA, identificado con DNI N° 42225869, con poderes inscritos en el asiento N° C00001, de la referida partida electrónica electrónica; Declara ser propietario del predio identificado lote independizado UC. 11179 Ubic.Rur.Valle Chancay – Lambayeque/sector San Agustin/ predio Pescoran, Area ha.1.89, distrito de Pimentel, provincia de Chiclayo, departamento de Lambayeque, cuyo dominio, área, linderos, medidas perimétricas y demás especificaciones corren más ampliamente descritas en la Partida Registral Nº 02253033 del registro de propiedad inmueble de la oficina registral de Chiclayo - Zona Registral Nº II - Sede Chiclayo, predio que en lo sucesivo se le denominara El INMUEBLE, mismo que se encuentra sujeto a EL PROYECTO. Por otro lado, el CONSORCIO CUMBRES, debidamente representado por su Gerente General JORGE LUIS YACILA SIANCAS, identificado con DNI N° 16414190, con poderes inscritos en el asiento A00001 de la referida partida electrónica, a quien en adelante se le denominará en adelante EL VENDEDOR.
        </p>
  </div>
  ...
  <div class="clause">
    ...
    <p>
    Por el presente contrato el prominente VENDEDOR se compromete a dar en venta real y en enajenación perpetua la totalidad del lote C 3, donde según plano adjunto, cuyos linderos y medidas perimétricas detallan 60M2 de área total y 36M2 del área construida.</p>
    ...
    <p>PRECISAR PERÍMETRO Y DIMENSIONES DE LOTES</p>
            ...
            <li>POR LA DERECHA: CON EL MZ C LT 2</li>
            <li>POR LA DERECHA: CON EL MZ C LT 2</b></li>
            <li>POR LA IZQUIERDA: CON EL LOTE MZ C LT 4</li>
            </ul>

            <p><u>DETALLES (ANEXO 01)</u></p>
    ...
    <p><b><u>CUARTO: OBJETO DEL CONTRATO:</u></b></p>
        ...
        <p>Por el presente contrato, EL VENDEDOR se obliga a transferir la propiedad del bien descrito en la cláusula primera en favor de EL COMPRADOR. Por su parte, EL COMPRADOR se obligan a pagar a EL VENDEDOR el monto total del precio pactado en la cláusula siguiente, en la forma y oportunidad convenidas.</p>
    ...
    <p><b><u>QUINTO: PRECIO Y FORMA DE PAGO:</u></b></p>
        ...
        <p>El precio del bien objeto de la prestación a cargo de EL VENDEDOR asciende a la suma de S/ 79,805.00 el BHF asumirá S/ 44,805.00 y el saldo de s/. 35,000.00 (TREINTA Y CINCO MIL 00/100 SOLES), que EL COMPRADOR cancela de manera al contado al momento de llevarse a cabo la compra; mediante depósito en la cuenta del CONSORCIO siendo el N° 3056967606064. Que, a su vez tendrá tenerse una copia de la operación realizada para evitar problemas a posterior.</p>
    ...
    <p><b><u>SEXTO: OBLIGACIONES DE LAS PARTES:</u></b></p>
        ...
        <p>EL VENDEDOR se obliga a entregar el bien objeto de la prestación a su cargo en la fecha pactada en la cláusula décimo quinto y tener todas las cuotas cancelada descritas en el ANEXO 02, acto que se verificará con el acta de entrega del bien inmueble, procurándole a EL COMPRADOR tomar efectiva posesión de dicho bien. (ANEXO 02) </p>
    ...
    <p><b><u>OCTAVO: GASTOS Y TRIBUTOS:</u></b></p>
        ...
        <p>En las relaciones personales entre las partes, EL VENDEDOR asumirá o reembolsará a EL COMPRADOR, si es el caso, los tributos que correspondan al bien materia de la venta hasta antes de la transferencia; mientras que EL COMPRADOR, por su parte, asumirán los tributos que se generen con motivo de dicha transferencia y con posterioridad a ella.</p>
    ...
    <p><b><u>UNDÉCIMA: CONOCIMIENTO DE LAS NORMAS DEL BFH</u></b></p>
        ...
        <p>a)	Que la adquisición de la vivienda se ha financiado con el BFH.</p>

        <p>b)	Que, para la inscripción de una transferencia de la propiedad de la vivienda a un tercero, que hubiese efectuado EL COMPRADOR dentro del plazo de restricción establecido por las normas que regulan en BFH será necesaria la Constancia Favorable emitida por el Fondo MIVIVIENDA S.A. por lo que sin esta constancia no podrá inscribirse dicha transferencia de propiedad. En este caso EL COMPRADOR procederá a la devolución inmediata del importe del BFH y de los intereses generados según corresponda, al Fondo MIVIVIENDA S.A.</p>
    ...
    <div class="clause">
    <p><b><u>DOUDÉCIMA: DE LA RESOLUCIÓN DEL CONTRATO:</u></b></p>
        ...
        <p>a)	Que EL COMPRADOR incurra en las causales de pérdida del derecho al BFH según las normas que lo regulan.</p>

        <p>b)	La renuncia del COMPRADOR al BFH realizada según las normas del BFH.</p>

        <p>c)	Si en el plazo de dieciocho (18) meses contados desde la firma del presente contrato, EL COMPRADOR no llegase a ser beneficiario del BFH, dejando ambas partes claramente establecidas que esta causal también se verificará con la primera denegación de la asignación del BFH a EL COMPRADOR aun así no se hubiese terminado de cumplir el plazo de dieciocho (18) meses.</p>

        <p>d)	Si EL VENDEDOR, incumpliera alguna de sus obligaciones mencionadas en el presente contrato la otra parte podrá solicitar la devolución total de las sumas entregadas.</p>
    ...
    <p><b><u>DECIMO TERCERO: OBLIGACIONES DE LAS PARTES:</u></b></p>
        ...
        <p>EL VENDEDOR se obliga frente a EL COMPRADOR a entregar el inmueble materia de la presente compra venta en condiciones de habitabilidad y según la lista de acabados que figura en las Especificaciones Técnicas.</p>

        <p>El plazo de entrega de la vivienda será construido dentro de los 18 meses y será entregado bajo los cumplimientos y condiciones del bonista (BFH), es decir que se haya asignado al COMPRADOR. Asimismo, las partes acuerdan que será condición de la entrega del inmueble la cancelación total del precio de la presente compraventa y la firma de la Escritura Pública de Compraventa correspondiente. La entrega se llevará a cabo mediante suscripción de Acta de entrega y Recepción correspondiente.</p>
...
<p style="text-align: right;">Chiclayo, 02 de setiembre del 2024.</p>
<br>
<br><br>
<br>
...
<h1>ANEXO (01)</h1>
<br><br>
<h1>Características de tu casa con Techo Propio</h1>
    ...
    <div class="clause">
        ...
        <p>PISO 01</p>
            <li>01 ambiente para sala, comedor y área de cocina.</li>
            ...
            <p>Altura del módulo 2.50m de piso a techo </p>

        </ul>
    </div>
    <b><p>2. SISTEMA CONSTRUCTIVO</p></b>
...
<p>Elementos Estructurales:</p>
    ...
    <b><p>TECHOS</p></b>
    <li>Losa aligerada h=20.00 cm impermeabilizada. Reforzada con acero corrugado de fy=4200 kg/cm2, la cual contara          con sistema de evacuación de aguas pluviales.</li>
</ul>
</div>

<b><p>1.	CONDICIONES TECNICAS DE LA VIVIENDA</p></b>

<ul class="custom-list">
<b><p>1.1. AREA CONSTRUIDA
...
<p>PISOS
   ...
   <b> <p>CARPINTERIA</p></b>
    ...
    <b><p>INSTALACIONES SANITARIAS:</p></b>
    ...
    <b> <p>INSTALACIONES DE GAS: </p></b>
    <li>No tendrá instalaciones de gas.</li>

    <b> <p>INSTALACIONES DE TELEFONO/INTERNET/CABLE: </p></b>
...
<div class="clause">
    ...
    <p>Tipo de Habilitación urbana con construcción simultanea de viviendas, se efectuarán todos los servicios básicos reglamentados para urbanizaciones con fines de vivienda.</p>
        ...
        <p><b>AGUA Y ALCANTARILLADO:</b> Convencional, con conexión domiciliaria.</p>
        <p><b>LUZ: </b>Tendido eléctrico con alumbrado público, con conexión domiciliaria.</p>
