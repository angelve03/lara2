...
<head>
    ...
    <link rel="stylesheet" href={{asset('css/alitorres.css')}}>
    <style>
...
<BR>
    ...
    <h1>CONTRATO DE COMPROMISO DE COMPRA VENTA CONTADO</h1>

    <p>Conste el presente documento un CONTRATO PRIVADO DE COMPROMISO DE COMPRA VENTA CONTADO, que celebra de una parte:</p>
  ...
  <div class="clause">
    ...
    <p >
    Por el presente contrato el prominente <b>VENDEDOR</b> se compromete a dar en venta real  de  la <b>MZ -- LT --</b>, y en enajenación perpetua la totalidad del lote --M2, donde según plano adjunto, cuyos linderos y medidas perimétricas detallan --M2 de área total y 28 M2 del área construida.<b> DETALLES (ANEXO 02)</b></p>
    </div>
    </div>
...
<BR>
    ...
    <p>PRECISAR PERÍMETRO Y DIMENSIONES DE LOTES</p>
            ...
            <p>La compraventa pactada comprende, usos, costumbres, servidumbres, entradas, salidas y todo cuanto de hecho y por derecho corresponda al inmueble descrito en la Cláusula del presente instrumento sin reservar ni limitación alguna.</p>
     </div>
     <div class="clause">
    ...
    <p><b><u>QUINTO: PRECIO Y FORMA DE PAGO:</u></b></p>
        ...
        <p >El precio del bien objeto de la prestación a cargo de <b>EL VENDEDOR</b> asciende a la suma de S/ 00,000.00 (-----------------------------------00/100 Soles), dicho precio se encuentra ya con el descuento del BFH que será cancelado por <b>EL COMPRADOR</b> mediante depósito bancario  en la cuenta de ALITORRES.</p>
    ...
    <p><b><u>SEXTO: OBLIGACIONES DE LAS PARTES:</u></b></p>
        ...
        <p><b>EL VENDEDOR</b> se obliga a entregar el bien objeto de la prestación a su cargo en la fecha pactada en la cláusula décimo quinto, acto que se verificará cancelado  con el acta de entrega del bien inmueble, procurándole a <b>EL COMPRADOR</b> tomar efectiva posesión de dicho bien.<b> (ANEXO 02) </b></p>
...
<BR>
    ...
    <p><b><u>NOVENA: DE LA RESOLUCIÓN DEL CONTRATO:</u></b></p>
        ...
        <p>    En caso el <b>COMPRADOR</b> desista de la compra, la devolución será el 50% del monto de               dinero aportado, SIN SER SUJETA A RECLAMO.</p>
        <p>Si el incumplimiento proviene del prominente, <b>EL VENDEDOR</b>, la otra parte podrá solicitar la devolución total de la suma entregada además de un pago adicional por derecho de indemnización.</p>
    ...
    <p><b><u>DÉCIMA: DE LA GARANTÍA DE LA COMPRAVENTA:</u></b></p>
        ...
        <p><b>EL VENDEDOR</b> se reserva la propiedad del inmueble descrito en la Cláusula Segunda hasta que <b>EL COMPRADOR</b> hayan pagado en su totalidad  establecido como precio de venta, de conformidad con el artículo 1583º del Código Civil.</p>
...
<div class="clause">
        ...
        <p><b>EL COMPRADOR</b> deberá recibir el bien objeto de la prestación a cargo de <b>EL VENDEDOR</b>, en la forma y oportunidad pactadas, declarando conocer el estado de conservación y habitabilidad en que se encuentra.</p>
    </div>
    <div class="clause">
...
<h1>Características de tu casa con Techo Propio</h1>
    ...
    <div class="clause">
        ...
        <p><b>Área construida de 36.00 m2, en la cual se considera los ambientes:</b></p>

        <ul class="custom-list">
        <p><b>PISO 01</b></p>
            <li>01 ambiente para sala, comedor y área de cocina.</li>
            <li>01 dormitorios (uno para cama de dos plazas).</li>
    ...
    <p><b>2.	SISTEMA CONSTRUCTIVO</b></p>
        ...
        <p><b>Elementos Estructurales:</b></p>
            ...
            <li>Vivienda estructurada para 02 niveles + azotea.</li>
            <p><b>TECHOS:</b></p>
    ...
    <p><b>1.	CONDICIONES TECNICAS DE LA VIVIENDA</b></p>
        <p><b>1.1.	AREA CONSTRUIDA</b></p>
        <ul class="custom-list">
        <p><b>PISOS</b></p>
...
<ul class="custom-list">
    ...
    <li><b>PAVIMENTOS:</b> Asfaltado con veredas y sardineles de concreto.</li>
    <li><b>PARQUES:</b> Habilitados con plataforma deportiva, áreas verdes y juegos recreativo con todos los ornamentos reglamentarios.</li>
    <li><b>AGUA Y ALCANTARILLADO:</b> Convencional, con conexión domiciliaria.</li>
