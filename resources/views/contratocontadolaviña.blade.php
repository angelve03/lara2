...
<BR>
  ...
  <div class="clause">
    ...
    Por el presente contrato el prominente VENDEDOR se compromete a dar en venta real  de  la MZ -- LT --, y en enajenación perpetua la totalidad del lote --M2, donde según plano adjunto, cuyos linderos y medidas perimétricas detallan --M2 de área total y 28 M2 del área construida. DETALLES (ANEXO 02)</p>
    </div>
    </div>
...
<BR>
    ...
    <p><b><u>QUINTO: PRECIO Y FORMA DE PAGO:</u></b></p>
        ...
        <p >El precio del bien objeto de la prestación a cargo de EL VENDEDOR asciende a la suma de S/ 00,000.00 (-----------------------------------00/100 Soles), dicho precio se encuentra ya con el descuento del BFH que será cancelado por EL COMPRADOR mediante depósito bancario  en la cuenta de ALITORRES.</p>
    ...
    <p><b><u>SEXTO: OBLIGACIONES DE LAS PARTES:</u></b></p>
        ...
        <p>EL VENDEDOR se obliga a entregar el bien objeto de la prestación a su cargo en la fecha pactada en la cláusula décimo quinto, acto que se verificará cancelado  con el acta de entrega del bien inmueble, procurándole a EL COMPRADOR tomar efectiva posesión de dicho bien. (ANEXO 02) </p>
...
<BR>
    ...
    <p><b><u>NOVENA: DE LA RESOLUCIÓN DEL CONTRATO:</u></b></p>
        ...
        <p>    En caso el COMPRADOR desista de la compra, la devolución será el 50% del monto de               dinero aportado, SIN SER SUJETA A RECLAMO.</p>
        <p>Si el incumplimiento proviene del prominente, EL VENDEDOR, la otra parte podrá solicitar la devolución total de la suma entregada además de un pago adicional por derecho de indemnización.</p>
    ...
    <p><b><u>DÉCIMA: DE LA GARANTÍA DE LA COMPRAVENTA:</u></b></p>
        ...
        <p>EL VENDEDOR se reserva la propiedad del inmueble descrito en la Cláusula Segunda hasta que EL COMPRADOR hayan pagado en su totalidad  establecido como precio de venta, de conformidad con el artículo 1583º del Código Civil.</p>
...
<BR>
    ...
    <p><b><u>DECIMO CUARTO: DE LA RESOLUCIÓN DEL CONTRATO:</u></b></p>
        ...
        <p style="margin-left: 5em;">d)	Si EL VENDEDOR, incumpliera alguna de sus obligaciones mencionadas en el presente contrato la otra parte podrá solicitar la devolución total de las sumas entregadas.</p>
