...
<div class="header">
        <h1>
    <p style= "text-align: center; margin: 0;">ANEXO 01</p>
    <p style= "text-align: center; margin: 0;">CRONOGRAMA DE PAGOS</p>
    <p style= "text-align: center;margin: 0;">ALITORRES</p>
    <p style= "text-align: center;margin: 0;">RUC: 20605585907	    </p>
    <p style= "text-align: center;margin: 0;">PARTIDA ELECTRONICA: 11328386</p>
    ...
    <table class="centered-table" border="1" style="border-collapse: collapse; width: 100%;">
        ...
        <tbody>
            <tr>
                <td>NOMBRE:</td>
                <td colspan="5">VIVIANA DEL ROCIO CELIS VASQUEZ</td>
            </tr>
            <tr>
                <td>DIRECCIÓN:</td>
                <td colspan="5">CP.MURRUNGA Ca PANAMA 13000000</td>
            </tr>
            <tr>
                <td>DNI:</td>
                <td>72553708</td>
...
<div class="table-container">        
    <table class="centered-table" border="1" style="border-collapse: collapse; width: 100%;">
        <thead>
            ...
            <tr>
            <td colspan="4"  style="text-align: center; ">&nbsp; ALITORRES</td>
