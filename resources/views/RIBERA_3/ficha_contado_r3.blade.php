...
<head>
    ...
    <style>
        ...
        width: 100%;
        height: 180vh; 
        background-image: url('{{ asset('img/ficha_r3.png') }}');
...
<div class="background-container">
    ...
    <div class="clause">
        <p>
        EL CLIENTE DECLARA CONOCER QUE EL PROYECTO CONDOMINIO LA RIBERA III SE DESARROLLARÁ SOBRE EL PREDIO MATRIZ INSCRITO EN LA PARTIDA REGISTRAL N°11153420 DEL REGISTRO DE PREDIOS RURAL VALLE CHANCAY - LAMBAYEQUE/EN EL DISTRITO DE PIMENTEL DEL PROYECTO, ES DE SU CONOCIMIENTO QUE LA EMPRESA QUE DESARROLLA Y PROMOCIONA EL PROYECTO ES MARBECORP DESARROLLO CORPORATIVO S.A.C. DEBIDAMENTE INSCRITA EN LA PARTIDA REGISTRAL N° 11477103.				
</p>
    </div>
...
<div class="table-container">        
    <table class="centered-table" border="1" style="border-collapse: collapse; width: 100%;">
        ...
        <tbody>
            <tr>
                <td>NOMBRE DEL TITULAR:</td>
                <td colspan="3">ANGEL GABRIEL CELIS VASQUEZ</tr>
            <tr>
                <td>DIRECCIÓN:</td>
                <td colspan="3">CP.MURRUNGA Ca PANAMA 13000000</td>
            </tr>
...
<div class="table-container">        
    <table class="centered-table" border="1" style="border-collapse: collapse; width: 100%;">
        <thead>
            <tr>
            <td>UBICACIÓN:</td>
                <th colspan="8" style="text-align: center;">CONDOMINIO LA RIBERA III</th>
            </tr>
        </thead>
        <tbody>
            <tr>
...
<div class="table-container">        
    <table class="centered-table" border="1" style="border-collapse: collapse; width: 100%;">
        <tbody>
        <tr>
                <td rowspan="5">NRO OPERACIONES DE PAGO ABONADO</td>
...
<div class="table-container">        
    <table class="centered-table" border="1" style="border-collapse: collapse; width: 100%;">
        ...
        <tr>
                <td rowspan="5" style="padding: 30px;">OBSERVACIÓN:</td>
                <td colspan="5"style="width: 390px;"></td>
            </tr>
...
<H2><b>Chiclayo;</b>Viernes, 6 de Setiembre de 2024</H2>
...
<div class="background-container">
    ...
    <div class="clause">
        ...
        <p style="margin: 0;">
        2. Este contrato es válido para la separación del lote, identificada plenamente, como consta en la parte superior del presente documento, habiendo cancelado la cuota de separación, comprometiéndose a completar la inicial en el plazo señalado a continuación.</p>
        <p style="margin: 0;">
        ...
        12. El cliente declara brindar la información verídica para la postulación del bono familiar habitacional (BFH) a la firma del presente contrato.   </p>    
         <p style="margin: 0;">
        13. El cliente declara tener pleno conocimiento de la documentación del CONDOMINIO LA RIBERA III y su promotor al momento de la firma del presente contrato.</p>
        <p style="margin: 0;">
