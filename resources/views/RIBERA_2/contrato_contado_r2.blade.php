...
<body>
    ...
    <div class="header">
        ...
        <h1>CONTRATO DE COMPROMISO DE COMPRA VENTA AL CONTADO LA RIBERA II</h1>
  ...
  <div class="clause">
    ...
    Por el presente contrato el prominente <b>VENDEDOR </b>se compromete a dar en venta real de la <b>MZ L LT 11</b>, y en enajenación perpetua la totalidad del lote 72M2, donde según plano adjunto, cuyos linderos y medidas perimétricas detallan 72M2 de área total y 36M2 del área construida.</p>
   
    
    <p>LINDEROS DE LA PROPIEDAD:</p>
            <ul class="custom-list">
        
            <li>POR EL FRENTE: CON PASILLO</li>
            <li>POR EL FONDO: MZ L LT 25</li>
            <li>POR LA DERECHA: MZ L LT 1 Y MZ L LT 28</b></li>
            <li>POR LA IZQUIERDA: MZ L LT 3</li>
            </ul>

            <p><u><B>DETALLES (ANEXO 01)</B></u></p>
