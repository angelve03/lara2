...
<body>
    ...
    <div class="clause">
        ...
        <p>
        <b>EL CONSORCIO está compuesto por tres personas jurídicas que persiguen similares objetivos, INMOBILIARIA &CONSTRUTORA ALI TORRES E.I.R.L., identificada con RUC N°20605585907, inscrita en la Partida Electrónica N.º 11328386 del Registro de Personas Jurídicas de la Oficina Registral de Chiclayo, representada por su Gerente General sr. ELVIS HENRY TORRES SALDAÑA, identificado con DNI N.º 42225869, con poderes inscritos en el asiento N°.C00001, de la referida partida electrónica y QUBO GRUPO DESARROLLADOR S.A.C., con RUC N.º 20609441136, inscrita en la Partida Electrónica N.º 11395373 del Registro de Personas Jurídicas de la Oficina Registral de Chiclayo, representada por su Gerente General sr. JORGE LUIS YACILA SIANCAS, identificado con DNI N.º 16414190, con poderes inscritos en el asiento A00001 de la referida partida electrónica; SERVICIO A LA CONSTRUCCION MINERIA Y PETROLEO SRL., identificada con RUC N.º 20606684348, inscrita en la partida Electrónica N°11343668 del registro de personas jurídicas de la oficina Registral de Chiclayo representada por su gerente general sr. CARRASCO OSORIO ROBERTO CARLOS , identificado con DNI N°.71099586 ,  con poderes inscritos en el asiento B00001 de la referida partida electrónica quienes unidas mediante el contrato suscrito ante el notario público, respectivamente, constituyen el “CONSORCIO CUMBRES”; siendo la última de estas, el encargado de asumir la gerencia comercial del consorcio.       
        </p>
  ...
  <div class="clause">
    ...
    <p><b><u>QUINTO: PRECIO Y FORMA DE PAGO:</u></b></p>
        ...
        <p>El precio del bien objeto de la prestación a cargo de EL VENDEDOR asciende a la suma de S/ 52,000.00 (Cincuenta y Dos Mil Soles), dicho precio se encuentra ya con el descuento del BFH que será cancelado por EL COMPRADOR con el saldo de S/35,000.00 (Treinta y Cinco Mil Soles), mediante depósito en la cuenta del CONSORCIO.</p>
        <p>EL COMPRADOR cancela de manera al contado al momento de llevarse a cabo la compra; mediante depósito en la cuenta del CONSORCIO siendo el N.º 3056967606064. Que, a su vez tendrá tenerse una copia de la operación realizada para evitar problemas a posterior.</p>
    ...
    <p><b><u>SEXTO: OBLIGACIONES DE LAS PARTES:</u></b></p>
        ...
        <p>EL VENDEDOR se obliga a entregar el bien objeto de la prestación a su cargo en la fecha pactada en la cláusula décimo quinto y tener todas las cuotas canceladas descritas en el ANEXO 02, acto que se verificará con el acta de entrega del bien inmueble, procurándole a EL COMPRADOR tomar efectiva posesión de dicho bien. (ANEXO 02)</p>
    ...
    <div class="clause">
    p><b><u>DECIMO SEGUNDO: CONOCIMIENTO DE LAS NORMAS DEL BFH</u></b></p>
        ...
        <p>B)	La renuncia del EL COMPRADOR al BFH realizada según las normas del BFH.</p>
        <p>C)	Si en el plazo de treinta y seis (36) meses contados desde la firma del presente contrato, EL COMPRADOR no llegase a ser beneficiario del BFH, dejando ambas partes claramente establecidas que esta causal también se verificará con la primera denegación de la asignación del BFH a EL COMPRADOR aun así no se hubiese terminado de cumplir el plazo de treinta y seis (36) meses.</p>
        <p>D)	Si EL COMPRADOR no cumple con su obligación de cancelar el precio pactado sobre el inmueble descrito en la Cláusula Quinta, en la forma y fecha convenidas, el contrato quedará resuelto y EL VENDEDOR, conservará de modo definitivo la suma de dinero entregado por parte del EL COMPRADOR con anterioridad a la fecha de resolución de contrato.</p>
        <p>E)	Si EL VENDEDOR, incumpliera alguna de sus obligaciones mencionadas en el presente contrato la otra parte podrá solicitar la devolución total de las sumas entregadas.</p>
    ...
    <p><b><u>DECIMO TERCERO: OBLIGACIONES DE LAS PARTES:</u></b></p>
        ...
        <p>El plazo de entrega de la vivienda será en un plazo de treinta y seis (36) meses que será contabilizado a partir del cumplimiento de la condición del bonista, es decir que se haya asignado a EL COMPRADOR el BFH. Asimismo, las partes acuerdan que será condición de la entrega del inmueble la cancelación total del precio de la presente compraventa y la firma de la Escritura Pública de Compraventa correspondiente. La entrega se llevará a cabo mediante suscripción de Acta de entrega y Recepción correspondiente.</p>

        <p>El mencionado plazo podrá ser prorrogado a solicitud del EL VENDEDOR por causas debidamente fundamentadas que acrediten que la demora en la entrega se debe a razones de caso fortuito o fuerza mayor, para lo que se requerirá acuerdo entre las partes.</p>
...
<h2> 
ANEXO 02</h2>
<h1>CARACTERÍSTICAS DE TU DEPARTAMENTO CON TECHO PROPIO</h1>
    ...
    <p>3.	CONDICIONES TECNICAS DE LA VIVIENDA</p>
        <p>a.	AREA CONSTRUIDA</p>
        <ul class="custom-list">
        <p>PISOS</p>
            ...
            <p>APARATOS SANITARIOS Y GRIFERIA</p>
            ...
            <p>INSTALACIONES DE TELÉFONO/INTERNET/CABLE</p>
...
<ul class="custom-list">
    ...
    <li>PAVIMENTOS: Asfaltado con veredas y sardineles de concreto.</li>
    <li>PARQUES: Habilitados con plataforma deportiva, áreas verdes y juegos recreativo con todos los ornamentos reglamentarios.</li>
    <li>AGUA Y ALCANTARILLADO: Convencional, con conexión domiciliaria.</li>
    <li>LUZ: Tendido eléctrico con alumbrado público, con conexión domiciliaria.</li>
